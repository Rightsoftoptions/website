      ...
      <div class="row">
        <div class="col-md-12">
          <div class="portfolio-area">
            <div class="title-area">
              <h2 class="tittle">Our Placed Students</h2>
              </div>
            <!-- Portfolio content -->
            <div class="portfolio-content">
               ...
               <div id="mixit-container" class="portfolio-container">
                   <?php
         $sql= mysql_query("select * from placements");
         while($ar=mysql_fetch_array($sql))
         {
            $a=$ar['id']; 
            $b=$ar['name'];
            ...
            ?>
                   ...
                   <div class="single-item">
                       <img src="assets/images/<?php echo $f ; ?>" alt="img">
                     <div class="single-item-content">
                        <div class="portfolio-social-icon">
                          <a class="fancybox" data-fancybox-group="gallery" href="assets/images/<?php echo $f ; ?>"><i class="fa fa-eye"></i></a>
                        </div>
